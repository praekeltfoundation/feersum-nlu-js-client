...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FeersumNluApi.SimilarityEntCreateDetails();
  });
  ...
  describe('SimilarityEntCreateDetails', function() {
    it('should create an instance of SimilarityEntCreateDetails', function() {
      // uncomment below and update the code to test SimilarityEntCreateDetails
