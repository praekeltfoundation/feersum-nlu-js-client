...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FeersumNluApi.Lr4CreateDetails();
  });
  ...
  describe('Lr4CreateDetails', function() {
    it('should create an instance of Lr4CreateDetails', function() {
      // uncomment below and update the code to test Lr4CreateDetails
      //var instane = new FeersumNluApi.Lr4CreateDetails();
      //expect(instance).to.be.a(FeersumNluApi.Lr4CreateDetails);
    });
