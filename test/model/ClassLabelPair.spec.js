...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FeersumNluApi.ClassLabelPair();
  });
  ...
  describe('ClassLabelPair', function() {
    it('should create an instance of ClassLabelPair', function() {
      // uncomment below and update the code to test ClassLabelPair
