...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FeersumNluApi.DucklingEntCreateDetails();
  });
  ...
  describe('DucklingEntCreateDetails', function() {
    it('should create an instance of DucklingEntCreateDetails', function() {
      // uncomment below and update the code to test DucklingEntCreateDetails
